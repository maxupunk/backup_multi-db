//! Espaço disponível por destino (tarefa 8.13 do roadmap).
//!
...
/// não os inclui. Num ext4 com os 5% de reserva padrão, o back-roco reporta
...
mod tests {
    ...
    fn a_missing_path_has_no_space() {
        let missing = std::env::temp_dir().join("back-roco-caminho-que-nao-existe");
