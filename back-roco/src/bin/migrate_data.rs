//! Migrador de dados Adonis -> back-roco (tarefa 4.9 do roadmap).
//!
//! A decisao D4 e' **schema novo**, entao os dados nao vem de graca: este
//! programa le' o SQLite do AdonisJS e popula o banco do back-roco, tabela a
...
//! Lucid grava assim. As colunas do back-roco tem afinidade TEXT e o Sea-ORM
