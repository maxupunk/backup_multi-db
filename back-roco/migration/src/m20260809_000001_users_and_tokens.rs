...
//! que esta' sendo portada, e mante-las faria o `back-roco` expor um schema que
//! o `docs/schema-baseline.sql` nao tem (tarefa 4.8).
//!
...
//! (ver abaixo). A diferenca esta' registrada como justificada no
//! `schema_diff`.
//!
